---
title: "RF MTV & IDM - Radiomic model - With SMOTENC"
author: "Farid"
date: "`r Sys.Date()`"
...
## Building the model for 5-PS prediction using IDM and MTV.
```{r}
...
rf_res_2 %>%
  ...
  theme_pubr()
# ggsave("roc_tr_rad.png", plot = roc_tr_rad, width = 12, height = 10, units = "cm", dpi = 600)
...
final_res_rf %>% 
  ...
  geom_abline(lty = 1, color = "black", size = 0.5) +
  theme_pubr() 
#ggsave("roc_te_rad.png", plot = roc_te_rad, width = 12, height = 10, units = "cm", dpi = 600)
